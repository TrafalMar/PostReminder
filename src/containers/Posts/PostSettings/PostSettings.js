      ...
      <div className={classes.PostSettings}>
        <div className={classes.Field}>
          ...
          <span className={classes.Switch}>
            <Switch
              checked={props.focusedPost.settings.private}
              toggler={props.togglePostPrivacy}
            />
          </span>
        </div>
        <Button
          color="green"
          onClick={() => {
            props.savePostAndCloseSettings(
              props.focusedPost,
              props.focusedPostId,
              props.token
            );
...
const mapDispatchToProps = (dispatch) => ({
  ...
  savePostAndCloseSettings: (post, id, token) =>
    dispatch(action.savePostAndCloseSettings(post, id, token)),
