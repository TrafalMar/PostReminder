        ...
        {this.state.isDeleting ? (
          <Aux>
            ...
            <CustomButton
              ...
              onClick={() => this.deletingHandler(false)}
            >
              NO
            </CustomButton>
          </Aux>
          ...
          <Aux>
            {this.props.editMode ? (
              <Aux>
                <CustomButton
                  color="red"
                  style={{ marginRight: "auto" }}
                  onClick={() => this.deletingHandler(true)}
                >
                  <FaTrash />
                </CustomButton>
                {this.props.settingsImplemented ? (
                  <CustomButton
                    color="gray"
                    style={{ marginRight: "auto" }}
            ...
            >
              <MenuItem
                onClick={() => {
                  this.handleCloseMenu(this.props.postId, "Title");
                }}
              >
                Title
              </MenuItem>
              <MenuItem
                onClick={() => {
                  this.handleCloseMenu(this.props.postId, "Paragraph");
                }}
              >
                Paragraph
              </MenuItem>
              <MenuItem
                onClick={() => {
                  this.handleCloseMenu(this.props.postId, "Image");
                }}
              >
                Image
              </MenuItem>
            ...
            <CustomButton color="red" onClick={this.props.editToggler}>
              {this.props.editMode ? <FaSave /> : <FaPencilAlt />}
            </CustomButton>
          </Aux>
        )}
      </div>
