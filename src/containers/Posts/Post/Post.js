...
class Post extends Component {
  render() {
    ...
    return (
      <Droppable droppableId={String(this.props.postId)}>
        {(provided) => (
          <Aux>
            <div
              {...provided.droppableProps}
              ref={provided.innerRef}
              onKeyUp={(event) => onEnterClick(event)}
              className={
                !this.props.editMode
                  ? classes.Post
                  : [classes.Post, classes.Editing].join(" ")
              }
            >
              {content}
              ...
              this.props.userId === this.props.authenticatedUserId ? (
                <div className={classes.PostControls}>
                  <PostControls
                    ...
                    openSettings={() => {
                      openSettingsWithBackdrop(this.props.postId);
                    }}
